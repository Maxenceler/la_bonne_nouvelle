...
question3D = Question.create!(step: step1, content: "Voici quelques diagnostiqueurs proches de chez vous. N'hésitez pas à rappeler ceux qui ont déjà travaillé sur votre bien. Déposez les documents sur votre espace projet 👇  Nous allons en avoir besoin pour la création de l’annonce.", name: "choix diagnostiqueurs", next_question_name: "estimation-precise")
...
response5B = Response.new(content: "Non merci", next_question_name: "comparaison-professionnels")
response5B.question = question5A
response5B.save!

question5B = Question.create!(step: step2, content: "J’estime que votre bien peut être vendu entre %s € et %s €", name: "estimation-votre-maison", next_question_name: "creation-annonce")
...
Cela dit, attention à ne jamais signer de contrat d’exclusivité avec une agence !", name: "comparaison-professionnels", next_question_name: "creation-annonce")
...
question7A = Question.create!(step: step3, content: "Nous allons désormais pouvoir créer l’annonce de vente de votre bien.", name: "creation-annonce", next_question_name: "annonce-cree")
